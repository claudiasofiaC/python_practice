...
class Virus():
    def __init__(self, params):
        ...
        self.mild = {i: {"thetas": [], "rs": []} for i in range(self.mild_fast, 365)} # using a year as an example
        self.severe = {
...
# exposing the virus in waves
# population set to 4500
    def spread_virus(self, i):
        ...
        if self.day % self.serial_interval == 0 and self.exposed_before < 4500:
            ...
            # since not everyone that is exposed contracts the virus, set 10% of pop to not susceptible
    ...
    def update_status(self):
        ...
        if self.day >= self.severe_fast:
            ...
            recs_rs = self.severe["recovery"][self.day]["rs"]
            self.axes.scatter(rec_thetas, recs_rs, s=5, color=GREEN)
